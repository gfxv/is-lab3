...
import dev.gfxv.lab3.dao.*;
import dev.gfxv.lab3.dao.enums.Weapon;
import dev.gfxv.lab3.dto.ChapterDTO;
import dev.gfxv.lab3.dto.CoordinatesDTO;
import dev.gfxv.lab3.dto.EditHistoryDTO;
import dev.gfxv.lab3.dto.SpaceMarineDTO;
import dev.gfxv.lab3.exceptions.NotFoundException;
import dev.gfxv.lab3.exceptions.UserNotFoundException;
import dev.gfxv.lab3.repository.*;
...
public class SpaceMarineService {
    ...
    public List<SpaceMarineDTO> getAllMarines() {
    ...
    @Transactional
    public Long newMarine(@Valid SpaceMarineDTO spaceMarineDTO, String owner) throws UserNotFoundException {
        ...
        SpaceMarineDAO created = spaceMarineRepository.save(spaceMarine);
