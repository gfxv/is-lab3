...
import dev.gfxv.lab3.dto.ws.ResponseType;
import dev.gfxv.lab3.dto.ws.TableRecordsResponse;
...
import dev.gfxv.lab3.service.SpaceMarineService;
...
public class SpaceMarineController {
    ...
    public ResponseEntity<?> newMarine(
        ...
        try {
            Long createdId =  spaceMarineService.newMarine(spaceMarineDTO, username);
    ...
    @GetMapping("/all")
    public ResponseEntity<?> getAllMarines() {
        List<SpaceMarineDTO> marines = spaceMarineService.getAllMarines();
        return new ResponseEntity<>(marines, HttpStatus.OK);
    }
